...
public class ByteEchoClientHandler extends SimpleChannelInboundHandler<ByteBuf> {
    ...
    public void channelActive(final ChannelHandlerContext ctx) {
        ...
        MqttFixedHeader mqttFixedHeader=new MqttFixedHeader(MqttMessageType.CONNACK,
        		false, MqttQoS.AT_LEAST_ONCE, false, 0);
        
        MqttConnectVariableHeader variableHeader=new MqttConnectVariableHeader("123456", 
        		MqttVersion.MQTT_3_1_1.ordinal(),false,false,false,MqttQoS.AT_LEAST_ONCE.value(),false,false,0);
        MqttConnectPayload payload=new MqttConnectPayload("123456", null, null, "user", "user123456");
